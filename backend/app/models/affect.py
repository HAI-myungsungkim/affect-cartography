...
from sqlalchemy import DateTime, Float, Integer, String, Enum, Boolean, ForeignKey, func
from sqlalchemy import JSON
from sqlalchemy.dialects.postgresql import UUID, JSONB

# Postgres에서는 JSONB, SQLite(테스트)에서는 JSON으로 폴백
...
class AffectRecord(Base):
    ...
    # 궤도 모드일 때 좌표 시퀀스 [{"v":-0.3,"a":0.1,"t":0}, ...] (t는 ms 오프셋)
